...
extern int(__thiscall* player_scrollView)(void *player, float x, float y, int unk);
...
{
	g_pVoobly->Write(0x00502509, (DWORD)&sub_7D0230 - 0x0050250D);
	g_pVoobly->Write(0x004FA309, (DWORD)&sub_7D0230 - 0x004FA30D);
	//writeDword(0x0050688C, (DWORD)&sub_7D0230 - 0x00506890); //gather point

	g_pVoobly->WriteJump(0x005D14C6, onElevation1);
	g_pVoobly->WriteJump(0x00502017, onElevation2);
	g_pVoobly->WriteJump(0x0050610E, onElevation3);
	g_pVoobly->WriteJump(0x005061EE, onElevation4);
	g_pVoobly->WriteJump(0x005062D4, onElevation5);
}
